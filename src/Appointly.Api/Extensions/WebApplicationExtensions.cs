...
namespace Appointly.Api.Extensions
{
    public static class WebApplicationExtensions
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var logger = services.GetRequiredService<ILoggerFactory>()
                                 .CreateLogger("Appointly.Api.DatabaseInitializer");

            try
            {
                var dbContext = services.GetRequiredService<AppointlyDbContext>();
                ...
                if (string.IsNullOrWhiteSpace(demoPassword))
                {
                    ...
                    logger.LogWarning(
                        ...
                        "\"<password>\" --project src/Appointly.Api");
                }
            ...
            CancellationToken cancellationToken)
        {
            ...
            if (knownMigrations.Count == 0)
            {
                throw new InvalidOperationException(
                    ...
                    "--project src/Appointly.Infrastructure --startup-project src/Appointly.Api");
            }
